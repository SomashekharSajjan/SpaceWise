...
function DriveLarge() {
  ...
  // ==========================================
  // LOAD ALL LARGE FILES
  // ==========================================

  useEffect(() => {
    const loadLargeFiles =
      async () => {
        try {
          setLoading(true);
          setError("");
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">
              All files consuming the most storage
            </p>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-5 py-8 lg:px-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-500">
            ...
            {loading
              ? "Loading..."
              : `${files.length.toLocaleString()} large files found`}
                ...
                {files.map(
                  (file, index) => (
                    ...
                    >
                      ...
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white/[0.05] text-xs font-semibold text-zinc-500">
